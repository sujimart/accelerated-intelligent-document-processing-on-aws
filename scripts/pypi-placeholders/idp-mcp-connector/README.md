# idp-mcp-connector — reserved name placeholder

**This is not a functional package.** It contains no code and importing it
raises `RuntimeError`.

This name is reserved by Amazon Web Services for the local MCP connector of the
...
## Looking for the real connector?

`idp_mcp_connector` ships inside the accelerator repository and is installed from a
